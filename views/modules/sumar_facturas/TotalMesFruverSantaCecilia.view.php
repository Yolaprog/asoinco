...
<div class="full-box page-header">
	<h3 class="text-left">
		<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; TOTAL MES FACTURAS FRUVER SANTA CECILIA
		<hr>
		<a href="?c=TotalFacturasControllers&a=ConsultarTotalFacturasFruverSantaCeciliaControllers" class="btn btn-secondary">Atrás</a>
	</h3>
</div>
<!-- Content -->
